...
class RecorderBot:
    ...
    def __init__(self, history_folder):
        ...
        :param history_folder: Path where the file must be saved """
        if os.path.isdir(history_folder):
            self.path = history_folder
        else:
            raise FileNotFoundError('History path "{}" not found.'.format(history_folder))
        self.user_context = {}
    ...
    def update_record(self, user_id, record_path, record_data):
        ...
        :param user_id: Id of the user
        :param record_path: path to the json file"""
    ...
    def initialize_bot_data(self, bot_id, user_id, context):
        ...
        :return: return the dialogue record to be added to context
        """
        if 'previous_dialogue_record' in context.bot_data:
            self.previous_dialogue_record = context.bot_data['previous_dialogue_record']
